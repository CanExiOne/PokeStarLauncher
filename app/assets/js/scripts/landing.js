...
function updateSelectedAccount(authUser){
    ...
    if(authUser != null){
        ...
        if(authUser.uuid != null && !authUser.uuid.startsWith("nonpremium_")){
            document.getElementById('avatarContainer').style.backgroundImage = `url('https://crafatar.com/renders/body/${authUser.uuid}')`
        }else if(authUser.uuid != null && authUser.uuid.startsWith("nonpremium_")){
...
function updateSelectedServer(serv){
    ...
    ConfigManager.save()
    server_selection_button.innerHTML = '\u2022 ' + (serv != null ? serv.getName() : 'Nie wybrano serwera')
    if(getCurrentView() === VIEWS.settings){
...
server_selection_button.innerHTML = '\u2022 Wczytywanie..'
    ...
    sysAEx.on('message', (m) => {
        ...
        if(m.context === 'validateJava'){
            if(m.result == null){
                ...
                setOverlayContent(
                    'Brak Kompatybilnej<br>instalacji Java',
                    'Żeby dołączyć na PokeStars, Musisz mieć zainstalowaną Jave 8? Instalując akceptujesz warunki umowy Oracle <a href="http://www.oracle.com/technetwork/java/javase/terms/license/index.html"></a>.',
                    'Zainstaluj Java',
                ...
                setDismissHandler(() => {
                    $('#overlayContent').fadeOut(250, () => {
                        ...
                        setOverlayContent(
                            ...
                            'A valid x64 installation of Java 8 is required to launch.<br><br>Please refer to our <a href="https://github.com/CanExiOne/PokeStarsLauncher/wiki/Java-Management#manually-installing-a-valid-version-of-java">Java Management Guide</a> for instructions on how to manually install Java.',
                            'I Understand',
                            'Go Back'
                        )
                        setOverlayHandler(() => {
            ...
            if(m.result === true){
                ...
                setOverlayContent(
                    ...
                    'Unfortunately we\'ve encountered an issue while attempting to install Java. You will need to manually install a copy. Please check out our <a href="https://github.com/CanExiOne/PokeStarsLauncher/wiki">Troubleshooting Guide</a> for more details and instructions.',
                    'I Understand'
                )
                setOverlayHandler(() => {
                    toggleOverlay(false)
        ...
        if(m.context === 'validate'){
            switch(m.data){
                case 'distribution':
                    ...
                    setLaunchDetails('Wczytywanie informacji o wersji..')
                    break
                case 'version':
                    setLaunchPercentage(40, 100)
                    loggerLaunchSuite.log('Informacje o wersji wczytane.')
                    setLaunchDetails('Sprawdzanie spójności plików..')
                    break
                case 'assets':
                    setLaunchPercentage(60, 100)
                    loggerLaunchSuite.log('Sprawdzanie spójności plików ukończone')
                    setLaunchDetails('Sprawdzanie spójności bibliotek..')
                    break
                case 'libraries':
                    setLaunchPercentage(80, 100)
                    loggerLaunchSuite.log('Sprawdzanie spójności bibliotek ukończone.')
                    setLaunchDetails('Sprawdzanie spójności plików..')
                    break
                case 'files':
            ...
            switch(m.data){
                case 'download':
                    ...
                    if(m.error.code === 'ENOENT'){
                        showLaunchFailure(
                            'Download Error',
                            'Nie udało się połączyć z serwerem plików. Upewnij się, że masz połączenie z internetem i spróbuj ponownie.'
                        )
                    } else {
                        showLaunchFailure(
                            'Download Error',
            ...
            if(login && allGood) {
                ...
                loggerLaunchSuite.log(`Wysyłanie wybranego konta (${authUser.displayName}) do ProcessBuilder.`)
                ...
                const gameStateChange = function(data){
                    ...
                    if(SERVER_JOINED_REGEX.test(data)){
                        DiscordWrapper.updateDetails('Zwiedzanie świata PokeStars!')
                    } else if(GAME_JOINED_REGEX.test(data)){
                        DiscordWrapper.updateDetails('Podróżowanie do PokeStars!')
                    }
                }
                ...
                const gameErrorListener = function(data){
                    ...
                    if(data.indexOf('Could not find or load main class net.minecraft.launchwrapper.Launch') > -1){
                        ...
                        showLaunchFailure('Error During Launch', 'The main file, LaunchWrapper, failed to download properly. As a result, the game cannot launch.<br><br>To fix this issue, temporarily turn off your antivirus software and launch the game again.<br><br>If you have time, please <a href="https://github.com/CanExiOne/PokeStarsLauncher/issues">submit an issue</a> and let us know what antivirus software you use. We\'ll contact them and try to straighten things out.')
                    }
                }
                ...
                try {
                    ...
                    setLaunchDetails('Gotowe. Miłej gry!')
...
function setNewsLoading(val){
    if(val){
        const nLStr = 'Wczytywanie Aktualności'
        let dotStr = '..'
